{<img src="https://travis-ci.org/everyleaf/kozuchi.png" />}[https://travis-ci.org/everyleaf/kozuchi.png]
...
Master works in Rails 3 and Ruby >= 1.9.
* You can use rails2 branch with Ruby 1.8.7 though its features are pretty old.
